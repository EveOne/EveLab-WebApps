...
SpriteMorph.prototype.initBlocks = function () {
    ...
    */
        ...
        //EveBrain functions - shame this is wrapped in a function call :-(
        evebrainGpio_on: {
          only: Process,
          type: 'command',
          category: 'Evelab',
          spec: 'Pin Number %pin On',
          defaults: [2]
        },
        evebrainGpio_off: {
          only: Process,
        ...
        evebrainMPR121_read: {
          ...
          type: 'reporter',
          category: 'Evelab',
          spec: 'MPR 121 Touch sensor data',
        },
        evebrainGpio_pwm: {
          only: Process,
          type: 'command',
          category: 'Evelab',
          spec: 'Pin %pwmPin level %n',
        },
        evebrainTemp_c: {
          only: Process,
          type: 'reporter',
        ...
        evebrainSetTempPin: {
          ...
          type: 'command',
          category: 'Evelab',
          spec: 'Temperature Sensor pin %analogPin',
        },
        evebrainCDS: {
          only: Process,
          type: 'reporter',
          category: 'Evelab',
          spec: 'Light Sensor Value',
        },
        evebrainSetCDSPin: {
          only: Process,
          type: 'command',
          category: 'Evelab',
          spec: 'Light Sensor pin %analogPin',
        },
        evebrainSetSpeakerPin: {
          only: Process,
          type: 'command',
          category: 'Evelab',
          spec: 'Buzzer pin %pin',
        ...
        evebrainPlayNote: {
          ...
          type: 'command',
          category: 'Evelab',
          spec: 'Play note %playNote duration %n',
        },
        evebrainStop: {
          only: Process,
          type: 'command',
...
SpriteMorph.prototype.blockTemplates = function (category) {
    ...
    */
    ...
    /////////////////////////////////
        ...
        blocks.push(block('evebrainGpio_on'));
        blocks.push(block('evebrainGpio_off'));
        blocks.push('-');
        blocks.push(block('evebrainGpio_read'));
        blocks.push(block('evebrainGpio_pwm'));
        blocks.push('-');
        blocks.push(block('evebrainMPR121_read'));
        blocks.push('-');
        blocks.push(block('evebrainSetTempPin'));
        blocks.push(block('evebrainTemp_c'));
        blocks.push(block('evebrainTemp_f'));
        blocks.push('-');
        blocks.push(block('evebrainSetCDSPin'));
        blocks.push(block('evebrainCDS'));
        blocks.push('-');
        blocks.push(block('evebrainSetSpeakerPin'));
