...
BlocklyApps.changeLanguage = function() {
  ...
  window.location = window.location.protocol + '//' +
      window.location.host + window.location.pathname + search + window.location.hash;
};
...
BlocklyApps.showCode = function(e) {
  var origin = e.target;
  var code = Blockly.JavaScript.workspaceToCode().replace(/Turtle/g, 'evebrain');
...
BlocklyApps.importPrettify = function() {
  ...
  link.setAttribute('href', '/assets/apps/blockly/css/prettify.css');
  document.head.appendChild(link);
  var script = document.createElement('script');
  script.setAttribute('type', 'text/javascript');
  script.setAttribute('src', '/assets/apps/blockly/js/prettify.js');
